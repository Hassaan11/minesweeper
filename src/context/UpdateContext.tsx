...
export const UpdateContext = createContext<UpdateContextProps>({ update: false, displayBoard: false, setUpdate: () => { }, setDisplayBoard: () => { } });
...
export const UpdateProvider = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <UpdateContext.Provider value={{ update, setUpdate, displayBoard, setDisplayBoard }}>
      {children}
